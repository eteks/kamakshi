...
--
-- Host: localhost
-- Generation Time: Sep 22, 2016 at 02:58 PM
...
CREATE TABLE IF NOT EXISTS `giftstore_orderitem` (
  ...
  `orderitem_product_attribute_group_id` int(11) NOT NULL COMMENT 'Stores the product attribute grouping id',
...
--
-- Table structure for table `giftstore_product_attribute_group`
--

CREATE TABLE IF NOT EXISTS `giftstore_product_attribute_group` (
  `product_attribute_group_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Stores the unique identification of product attribute grouping id',
  `product_mapping_id` int(11) NOT NULL COMMENT 'Stores the product mapping id',
  `product_attribute_group_price` decimal(10,2) NOT NULL COMMENT 'Stores the product attribute grouping price',
  `product_attribute_group_totalitems` bigint(15) NOT NULL COMMENT 'Stores the product attribute grouping totalitems',
  `product_attribute_value_combination_id` varchar(200) NOT NULL COMMENT 'Stores the product attribute value combination for the particular product',
...
CREATE TABLE IF NOT EXISTS `giftstore_product_attribute_value` (
  ...
  `product_attribute_id` int(11) NOT NULL COMMENT 'Stores the mapping id of product attribute',
...
--
-- Constraints for table `giftstore_product_attribute_group`
--
ALTER TABLE `giftstore_product_attribute_group`
  ADD CONSTRAINT `giftstore_product_attribute_group_ibfk_1` FOREIGN KEY (`product_mapping_id`) REFERENCES `giftstore_product` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE;
