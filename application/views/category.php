                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li>
                                    <a href="category.php">Baby<span class="badge pull-right">42</span></a>
                                    <ul>
                                        <li><a href="category.php">Bathing & Changing</a>
                                        </li>
                                        <li><a href="category.php">Toys & Activity</a>
                                        </li>
                                        <li><a href="category.php">Baby Gear</a>
                                        </li>
                                        <li><a href="category.php">Collectibles</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="row products">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Colourful Candle Set</a></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Red Teddy, Candles & Chocolate Hamper</a></h3>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Clock Cushion & Flower Hamper</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Chocolates & Candles Hamper</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Beautiful Morning Hamper</a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Cushion & Photo Frame </a></h3>
                                    <p class="price">$143.00</p>
                                    <p class="buttons">
                                        <a href="detail.php" class="btn btn-default">View detail</a>
                                        <a href="basket.php" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a>
