                    ...
                    <div class="box">
                        <form method="post" action="<?php echo base_url(); ?>index.php/checkout4">
                            ...
                            <ul class="nav nav-pills nav-justified">
                                ...
                                <li><a href="<?php echo base_url(); ?>index.php/checkout3"><i class="fa fa-money"></i><br>Payment Method</a>
                                </li>
                            ...
                            <div class="box-footer">
                                <div class="pull-left">
                                    <a href="<?php echo base_url(); ?>index.php/checkout3" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Payment method</a>
                                </div>
