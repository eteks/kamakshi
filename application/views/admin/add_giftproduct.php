                            ...
                            <div class="form-group attribute_block">
                                <div class="clone_attribute_group">
                                    <div class="clone_attribute" id="clone_attribute1">
                                        ...
                                        <select name="select_attribute[]" id="sel_c" class="product-type-filter form-control fl label-boxes field_validate">
                                        ...
                                        <input class="form-control fl label-boxes field_validate" id="total_iteams" placeholder="Enter Attribute value" name="attribute_value[]" type="text">
