...
<?php } ?>
             ...
             <p class="product_tab">Basic Product Details</p>
                    ...
                    <div class="form-group deliver-to-city">
                        <label>Applicable city to deliver<!-- <span class="fill_symbol"> *</span> --></label>
                        <a href='#' id='select-all'>select all</a>
                        <span>/<span>
                        <a href='#' id='deselect-all'>deselect all</a>
                        <select id='custom-headers' multiple='multiple' class="searchable product_city" name="applicable_city[]">
                        <?php foreach ($city_list as $city): 
                            if(sizeof($product_city_list) > 0){
                        ?>
                            <option value="<?php echo $city["city_id"] ?>" <?php if(in_array($city["city_id"], $product_city_list)) echo "selected"; ?>><?php echo $city["city_name"] ?></option>
                        <?php } else{ ?>
