 ...
 _________________________________________________________ -->
        ...
        <div id="hot">
            <section id="our-works" class="page bg-style1">
                ...
                <div class="container">
                    <div class="product-slider" id="portfolio">
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Baby</a></h3>
                                    <br />
                                </div>
                                <!-- /.text -->
                            </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Business & Executive Gifts
</a></h3>
                                    <br />
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Eco-Friendly</a></h3>
                                    <br />
                                </div>
                                <!-- /.text -->
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.php">Fashion & Style</a></h3>
                                    <br />
                                </div>
                                <!-- /.text -->
                            </div>
